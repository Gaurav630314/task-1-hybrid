...
resource "null_resource" "null-remote-1"  {
  ...
  provisioner "remote-exec" {
      inline = [
       ...
       "sudo git clone https://github.com/Gaurav630314/task-1-hybrid.git  /var/www/html/",
      ]
  }
}
...
depends_on = [
 ...
 provisioner "local-exec" {
    command = "git clone https://github.com/Gaurav630314/task-1-hybrid.git  C:/Users/Admin/Desktop/terra/repo/"
    when    = destroy
  }
}
